// Kernel headers and trace event definitions
#include "vmlinux.h"
// helper functions that make life nicer
#include <bpf/bpf_helpers.h>
// tracing functions to help us deal with ring buffers
#include <bpf/bpf_tracing.h>
// access struct fields in a safe manner
#include <bpf/bpf_core_read.h>
// defines our event we send into userspace
#include "oomkill.h"
...
// An example had this but I don't think we're actually using this map so shrug.emoji
struct {
...
// Our ringbuffer where kernel stuff goes in. This is the preferred way vs perf buffers for kernel > 5.8
struct {
...
// TODO: change back to SEC("tp/oom/mark_victim")
...
int handle_tp(struct  trace_event_raw_mark_victim *ctx) {
  ...
  // cast the random u64 we get as a pointer to a task struct. don't worry kids we're gonna do way more memory crimes.
  ...
  bpf_get_current_comm(e->my_comm, PROBE_COMM_LEN);
